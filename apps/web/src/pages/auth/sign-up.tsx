...
import { CardContent } from "@agentclave/ui/components/card";
...
export function SignUpPage() {
	...
	return (
		<AuthFormLayout title="Create an account" description="Start using AgentClave" footer={
			...
			<form.AppForm>
				<form.Form>
					<CardContent className="space-y-4">
						...
						<FormTextField name="email" label="Email" type="email" placeholder="you@example.com" required />
						<FormTextField name="password" label="Password" type="password" placeholder="••••••••" required />
