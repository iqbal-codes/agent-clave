...
- `apps/web/src/pages/agent-detail.tsx`
...
**Pattern notes:** Replace these in place. Keep page-level padding and heading hierarchy unless a shared product page header component is introduced.
